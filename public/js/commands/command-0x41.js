        ...
        render(container) {
            ...
            let html = `
                <div class="form-group">
                    <label>${isZh ? '数据包类型: RESPONSE' : 'Packet Type: RESPONSE'}</label>
                </div>
                <div class="form-group">
                    <label for="field-product-type-0x41">${isZh ? '产品类型:' : 'Product Type:'}</label>
                    <select id="field-product-type-0x41" class="payload-input">
