...
### 原有命令 (22个)
- 0x00-0x03, 0x06-0x07, 0x09, 0x14-0x17, 0x19-0x21, 0x30-0x36, 0x41, 0x59

### 新增命令 (37个)
- **ANC和音效控制**: 0x37-0x38, 0x44-0x47, 0x60-0x61
- **设备管理**: 0x4A-0x4F, 0x5D
- **语音和提示**: 0x57-0x58, 0x5B-0x5C, 0x5E-0x5F, 0x66-0x67
- **按键和交互**: 0x5A, 0x64-0x65
- **显示和LED**: 0x68-0x69
- **音频处理**: 0x62-0x63, 0x70-0x73, 0x7C

### 最终统计
- **总命令数**: 59个（原有22个 + 新增37个）
- **文件数**: 60个（59个命令文件 + 1个基础类文件）
